...
function App() {
  const [color, setColor] = useState("linear-gradient(green, blue, purple)");


  return (
    <>
      <div className="h-screen border-2 border-blue-900">
      <div className="w-2/2 h-full duration-200" style={{background:color} }>
